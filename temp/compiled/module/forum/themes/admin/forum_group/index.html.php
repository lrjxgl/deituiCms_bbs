...
<tr>
  ...
  <td>
   ...
   <td>
	   <div class="<?php if ($this->_var['c']['isrecommend'] == 1): ?>yes<?php else: ?>no<?php endif; ?> js-toggle-status" url="/moduleadmin.php?m=forum_group&a=recommend&gid=<?php echo $this->_var['c']['gid']; ?>&ajax=1" ></div>
   </td>
